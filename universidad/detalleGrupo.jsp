...
<html>
  ...
  <table>
	<tr><td>N&uacute;mero:</td><td><input type="text" name="numero" value="<%= grupo.getNumero() %>"/></td></tr>
	...
	<tr><td>Id Profesor:</td><td><input type="text" name="idProfesor" value="<%= grupo.getIdProfesor() %>"/></td></tr>	
